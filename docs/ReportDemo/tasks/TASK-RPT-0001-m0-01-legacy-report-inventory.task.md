...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-legacy-report-inventory.task.md"
  - "docs/ReportDemo/evidence/M0-01/**"
  - "docs/ReportDemo/inventory/**"
  - "docs/ReportDemo/decision-records/**"
  - "legacy/舊系統報表模組_功能別001.xxx"
  - "legacy/舊系統資料轉換_SP_功能別001.sql"
deliverables:
  - "docs/ReportDemo/evidence/M0-01/implementation-notes.md"
  - "docs/ReportDemo/evidence/M0-01/validation-result.md"

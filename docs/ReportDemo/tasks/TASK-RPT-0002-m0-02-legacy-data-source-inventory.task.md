...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-legacy-data-source-inventory.task.md"
  - "docs/ReportDemo/evidence/M0-02/**"
  - "docs/ReportDemo/inventory/**"
  - "docs/ReportDemo/decision-records/**"
  - "legacy/舊系統報表模組_功能別002.xxx"
  - "legacy/舊系統資料轉換_SP_功能別002.sql"
deliverables:
  - "docs/ReportDemo/evidence/M0-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M0-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m0.legacy-data-source-inventory"
  mapUpdates:
...
完成 `M0-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別002.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別002.sql`

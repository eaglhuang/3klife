...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-third-party-cross-platform-poc.task.md"
  - "docs/ReportDemo/evidence/M0-04/**"
  - "docs/ReportDemo/inventory/**"
  - "docs/ReportDemo/decision-records/**"
  - "legacy/舊系統報表模組_功能別004.xxx"
  - "legacy/舊系統資料轉換_SP_功能別004.sql"
deliverables:
  - "docs/ReportDemo/evidence/M0-04/implementation-notes.md"
  - "docs/ReportDemo/evidence/M0-04/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m0.third-party-cross-platform-poc"
  mapUpdates:
...
完成 `M0-04` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別004.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別004.sql`

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-role-raci-critical-path.task.md"
  - "docs/ReportDemo/evidence/M0-06/**"
  - "docs/ReportDemo/inventory/**"
  - "docs/ReportDemo/decision-records/**"
  - "legacy/舊系統報表模組_功能別006.xxx"
  - "legacy/舊系統資料轉換_SP_功能別006.sql"
deliverables:
  - "docs/ReportDemo/evidence/M0-06/implementation-notes.md"
  - "docs/ReportDemo/evidence/M0-06/validation-result.md"

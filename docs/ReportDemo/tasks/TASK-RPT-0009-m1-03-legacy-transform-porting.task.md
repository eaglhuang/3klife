...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-legacy-transform-porting.task.md"
  - "docs/ReportDemo/evidence/M1-03/**"
  - "src/ReportDemo.Import/**"
  - "db/migrations/reportdemo/**"
  - "legacy/舊系統報表模組_功能別103.xxx"
  - "legacy/舊系統資料轉換_SP_功能別103.sql"
deliverables:
  - "docs/ReportDemo/evidence/M1-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M1-03/validation-result.md"

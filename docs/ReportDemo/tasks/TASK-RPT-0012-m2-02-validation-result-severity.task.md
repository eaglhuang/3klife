---
task_id: TASK-RPT-0012
source_milestone: M2-02
title: "建立檢核結果等級"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-validation-result-severity.task.md"
  - "docs/ReportDemo/evidence/M2-02/**"
  - "src/ReportDemo.Validation/**"
  - "db/migrations/reportdemo/**"
  - "legacy/舊系統報表模組_功能別202.xxx"
  - "legacy/舊系統資料轉換_SP_功能別202.sql"
deliverables:
  - "docs/ReportDemo/evidence/M2-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M2-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m2.validation-result-severity"
  mapUpdates:
...
---
# TASK-RPT-0012 - M2-02 建立檢核結果等級

## Goal

完成 `M2-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別202.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別202.sql`

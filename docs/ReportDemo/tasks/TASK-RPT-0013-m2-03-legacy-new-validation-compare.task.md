...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-legacy-new-validation-compare.task.md"
  - "docs/ReportDemo/evidence/M2-03/**"
  - "src/ReportDemo.Validation/**"
  - "db/migrations/reportdemo/**"
  - "legacy/舊系統報表模組_功能別203.xxx"
  - "legacy/舊系統資料轉換_SP_功能別203.sql"
deliverables:
  - "docs/ReportDemo/evidence/M2-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M2-03/validation-result.md"

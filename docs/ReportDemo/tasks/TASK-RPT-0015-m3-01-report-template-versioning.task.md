...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-report-template-versioning.task.md"
  - "docs/ReportDemo/evidence/M3-01/**"
  - "src/ReportDemo.Reporting/**"
  - "templates/reportdemo/**"
  - "legacy/舊系統報表模組_功能別301.xxx"
  - "legacy/舊系統資料轉換_SP_功能別301.sql"
deliverables:
  - "docs/ReportDemo/evidence/M3-01/implementation-notes.md"
  - "docs/ReportDemo/evidence/M3-01/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m3.report-template-versioning"
  mapUpdates:
...
---
# TASK-RPT-0015 - M3-01 建立報表模板版本

## Goal

完成 `M3-01` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別301.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別301.sql`

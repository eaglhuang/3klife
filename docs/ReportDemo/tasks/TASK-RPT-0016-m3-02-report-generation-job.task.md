...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-report-generation-job.task.md"
  - "docs/ReportDemo/evidence/M3-02/**"
  - "src/ReportDemo.Reporting/**"
  - "templates/reportdemo/**"
  - "legacy/舊系統報表模組_功能別302.xxx"
  - "legacy/舊系統資料轉換_SP_功能別302.sql"
deliverables:
  - "docs/ReportDemo/evidence/M3-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M3-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m3.report-generation-job"
  mapUpdates:
...
---
# TASK-RPT-0016 - M3-02 建立報表產生任務

## Goal

完成 `M3-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別302.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別302.sql`

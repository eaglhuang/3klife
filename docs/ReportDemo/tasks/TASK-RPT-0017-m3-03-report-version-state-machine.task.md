---
task_id: TASK-RPT-0017
source_milestone: M3-03
title: "建立報表版本與狀態機"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-report-version-state-machine.task.md"
  - "docs/ReportDemo/evidence/M3-03/**"
  - "src/ReportDemo.Reporting/**"
  - "templates/reportdemo/**"
  - "legacy/舊系統報表模組_功能別303.xxx"
  - "legacy/舊系統資料轉換_SP_功能別303.sql"
deliverables:
  - "docs/ReportDemo/evidence/M3-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M3-03/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m3.report-version-state-machine"
  mapUpdates:
...
---
# TASK-RPT-0017 - M3-03 建立報表版本與狀態機

## Goal

完成 `M3-03` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別303.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別303.sql`

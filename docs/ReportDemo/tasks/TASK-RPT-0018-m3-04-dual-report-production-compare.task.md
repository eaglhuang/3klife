...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-dual-report-production-compare.task.md"
  - "docs/ReportDemo/evidence/M3-04/**"
  - "src/ReportDemo.Reporting/**"
  - "templates/reportdemo/**"
  - "legacy/舊系統報表模組_功能別304.xxx"
  - "legacy/舊系統資料轉換_SP_功能別304.sql"
deliverables:
  - "docs/ReportDemo/evidence/M3-04/implementation-notes.md"
  - "docs/ReportDemo/evidence/M3-04/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m3.dual-report-production-compare"
  mapUpdates:
...
---
# TASK-RPT-0018 - M3-04 建立新舊報表雙製比對

## Goal

完成 `M3-04` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別304.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別304.sql`

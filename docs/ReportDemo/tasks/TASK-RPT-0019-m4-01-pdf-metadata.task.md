...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-pdf-metadata.task.md"
  - "docs/ReportDemo/evidence/M4-01/**"
  - "src/ReportDemo.DocumentStorage/**"
  - "infra/storage/reportdemo/**"
  - "legacy/舊系統報表模組_功能別401.xxx"
  - "legacy/舊系統資料轉換_SP_功能別401.sql"
deliverables:
  - "docs/ReportDemo/evidence/M4-01/implementation-notes.md"
  - "docs/ReportDemo/evidence/M4-01/validation-result.md"

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-pdf-storage-zone.task.md"
  - "docs/ReportDemo/evidence/M4-02/**"
  - "src/ReportDemo.DocumentStorage/**"
  - "infra/storage/reportdemo/**"
  - "legacy/舊系統報表模組_功能別402.xxx"
  - "legacy/舊系統資料轉換_SP_功能別402.sql"
deliverables:
  - "docs/ReportDemo/evidence/M4-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M4-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m4.pdf-storage-zone"
  mapUpdates:
...
---
# TASK-RPT-0020 - M4-02 建立 PDF 儲存區

## Goal

完成 `M4-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別402.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別402.sql`

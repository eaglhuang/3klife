...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-pdf-master-integrity-check.task.md"
  - "docs/ReportDemo/evidence/M4-03/**"
  - "src/ReportDemo.DocumentStorage/**"
  - "infra/storage/reportdemo/**"
  - "legacy/舊系統報表模組_功能別403.xxx"
  - "legacy/舊系統資料轉換_SP_功能別403.sql"
deliverables:
  - "docs/ReportDemo/evidence/M4-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M4-03/validation-result.md"

---
task_id: TASK-RPT-0022
source_milestone: M4-04
title: "建立 PDF reconciliation 處理"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-pdf-reconciliation.task.md"
  - "docs/ReportDemo/evidence/M4-04/**"
  - "src/ReportDemo.DocumentStorage/**"
  - "infra/storage/reportdemo/**"
  - "legacy/舊系統報表模組_功能別404.xxx"
  - "legacy/舊系統資料轉換_SP_功能別404.sql"
deliverables:
  - "docs/ReportDemo/evidence/M4-04/implementation-notes.md"
  - "docs/ReportDemo/evidence/M4-04/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m4.pdf-reconciliation"
  mapUpdates:
...
---
# TASK-RPT-0022 - M4-04 建立 PDF reconciliation 處理

## Goal

完成 `M4-04` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別404.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別404.sql`

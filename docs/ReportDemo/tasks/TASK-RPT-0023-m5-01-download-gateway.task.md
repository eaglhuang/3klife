...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-download-gateway.task.md"
  - "docs/ReportDemo/evidence/M5-01/**"
  - "src/ReportDemo.DownloadGateway/**"
  - "src/ReportDemo.Watermark/**"
  - "legacy/舊系統報表模組_功能別501.xxx"
  - "legacy/舊系統資料轉換_SP_功能別501.sql"
deliverables:
  - "docs/ReportDemo/evidence/M5-01/implementation-notes.md"
  - "docs/ReportDemo/evidence/M5-01/validation-result.md"

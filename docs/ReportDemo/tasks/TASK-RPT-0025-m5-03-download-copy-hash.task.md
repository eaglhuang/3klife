...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-download-copy-hash.task.md"
  - "docs/ReportDemo/evidence/M5-03/**"
  - "src/ReportDemo.DownloadGateway/**"
  - "src/ReportDemo.Watermark/**"
  - "legacy/舊系統報表模組_功能別503.xxx"
  - "legacy/舊系統資料轉換_SP_功能別503.sql"
deliverables:
  - "docs/ReportDemo/evidence/M5-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M5-03/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m5.download-copy-hash"
  mapUpdates:
...
---
# TASK-RPT-0025 - M5-03 建立下載副本 Hash

## Goal

完成 `M5-03` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別503.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別503.sql`

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-download-copy-retention-policy.task.md"
  - "docs/ReportDemo/evidence/M5-03A/**"
  - "src/ReportDemo.DownloadGateway/**"
  - "src/ReportDemo.Watermark/**"
  - "legacy/舊系統報表模組_功能別503A.xxx"
  - "legacy/舊系統資料轉換_SP_功能別503A.sql"
deliverables:
  - "docs/ReportDemo/evidence/M5-03A/implementation-notes.md"
  - "docs/ReportDemo/evidence/M5-03A/validation-result.md"

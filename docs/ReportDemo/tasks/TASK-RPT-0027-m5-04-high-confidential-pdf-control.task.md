---
task_id: TASK-RPT-0027
source_milestone: M5-04
title: "建立高機密 PDF 控制"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-high-confidential-pdf-control.task.md"
  - "docs/ReportDemo/evidence/M5-04/**"
  - "src/ReportDemo.DownloadGateway/**"
  - "src/ReportDemo.Watermark/**"
  - "legacy/舊系統報表模組_功能別504.xxx"
  - "legacy/舊系統資料轉換_SP_功能別504.sql"
deliverables:
  - "docs/ReportDemo/evidence/M5-04/implementation-notes.md"
  - "docs/ReportDemo/evidence/M5-04/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m5.high-confidential-pdf-control"
  mapUpdates:
...
---
# TASK-RPT-0027 - M5-04 建立高機密 PDF 控制

## Goal

完成 `M5-04` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別504.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別504.sql`

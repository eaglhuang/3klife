---
task_id: TASK-RPT-0029
source_milestone: M6-02
title: "建立安全預覽"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-secure-preview.task.md"
  - "docs/ReportDemo/evidence/M6-02/**"
  - "src/ReportDemo.Web/**"
  - "src/ReportDemo.Workflow/**"
  - "legacy/舊系統報表模組_功能別602.xxx"
  - "legacy/舊系統資料轉換_SP_功能別602.sql"
deliverables:
  - "docs/ReportDemo/evidence/M6-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M6-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m6.secure-preview"
  mapUpdates:
...
---
# TASK-RPT-0029 - M6-02 建立安全預覽

## Goal

完成 `M6-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別602.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別602.sql`

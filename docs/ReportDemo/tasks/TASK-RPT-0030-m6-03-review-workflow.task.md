---
task_id: TASK-RPT-0030
source_milestone: M6-03
title: "建立覆核流程"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-review-workflow.task.md"
  - "docs/ReportDemo/evidence/M6-03/**"
  - "src/ReportDemo.Web/**"
  - "src/ReportDemo.Workflow/**"
  - "legacy/舊系統報表模組_功能別603.xxx"
  - "legacy/舊系統資料轉換_SP_功能別603.sql"
deliverables:
  - "docs/ReportDemo/evidence/M6-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M6-03/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m6.review-workflow"
  mapUpdates:
...
---
# TASK-RPT-0030 - M6-03 建立覆核流程

## Goal

完成 `M6-03` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別603.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別603.sql`

---
task_id: TASK-RPT-0031
source_milestone: M6-04
title: "建立重產流程"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-regeneration-workflow.task.md"
  - "docs/ReportDemo/evidence/M6-04/**"
  - "src/ReportDemo.Web/**"
  - "src/ReportDemo.Workflow/**"
  - "legacy/舊系統報表模組_功能別604.xxx"
  - "legacy/舊系統資料轉換_SP_功能別604.sql"
deliverables:
  - "docs/ReportDemo/evidence/M6-04/implementation-notes.md"
  - "docs/ReportDemo/evidence/M6-04/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m6.regeneration-workflow"
  mapUpdates:
...
---
# TASK-RPT-0031 - M6-04 建立重產流程

## Goal

完成 `M6-04` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別604.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別604.sql`

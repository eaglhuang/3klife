...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-void-workflow.task.md"
  - "docs/ReportDemo/evidence/M6-05/**"
  - "src/ReportDemo.Web/**"
  - "src/ReportDemo.Workflow/**"
  - "legacy/舊系統報表模組_功能別605.xxx"
  - "legacy/舊系統資料轉換_SP_功能別605.sql"
deliverables:
  - "docs/ReportDemo/evidence/M6-05/implementation-notes.md"
  - "docs/ReportDemo/evidence/M6-05/validation-result.md"

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-log-sensitive-data-protection.task.md"
  - "docs/ReportDemo/evidence/M7-02/**"
  - "src/ReportDemo.Audit/**"
  - "src/ReportDemo.Alerting/**"
  - "legacy/舊系統報表模組_功能別702.xxx"
  - "legacy/舊系統資料轉換_SP_功能別702.sql"
deliverables:
  - "docs/ReportDemo/evidence/M7-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M7-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m7.log-sensitive-data-protection"
  mapUpdates:
...
---
# TASK-RPT-0034 - M7-02 建立 Log 敏感資料防護

## Goal

完成 `M7-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別702.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別702.sql`

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-alert-severity-routing.task.md"
  - "docs/ReportDemo/evidence/M7-03/**"
  - "src/ReportDemo.Audit/**"
  - "src/ReportDemo.Alerting/**"
  - "legacy/舊系統報表模組_功能別703.xxx"
  - "legacy/舊系統資料轉換_SP_功能別703.sql"
deliverables:
  - "docs/ReportDemo/evidence/M7-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M7-03/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m7.alert-severity-routing"
  mapUpdates:
...
---
# TASK-RPT-0035 - M7-03 建立告警分級

## Goal

完成 `M7-03` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別703.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別703.sql`

---
task_id: TASK-RPT-0036
source_milestone: M8-01
title: "建立角色管理"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-role-management.task.md"
  - "docs/ReportDemo/evidence/M8-01/**"
  - "src/ReportDemo.Admin/**"
  - "src/ReportDemo.Security/**"
  - "legacy/舊系統報表模組_功能別801.xxx"
  - "legacy/舊系統資料轉換_SP_功能別801.sql"
deliverables:
  - "docs/ReportDemo/evidence/M8-01/implementation-notes.md"
  - "docs/ReportDemo/evidence/M8-01/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m8.role-management"
  mapUpdates:
...
---
# TASK-RPT-0036 - M8-01 建立角色管理

## Goal

完成 `M8-01` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別801.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別801.sql`

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-data-scope-management.task.md"
  - "docs/ReportDemo/evidence/M8-02/**"
  - "src/ReportDemo.Admin/**"
  - "src/ReportDemo.Security/**"
  - "legacy/舊系統報表模組_功能別802.xxx"
  - "legacy/舊系統資料轉換_SP_功能別802.sql"
deliverables:
  - "docs/ReportDemo/evidence/M8-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M8-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m8.data-scope-management"
  mapUpdates:
...
---
# TASK-RPT-0037 - M8-02 建立資料範圍管理

## Goal

完成 `M8-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別802.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別802.sql`

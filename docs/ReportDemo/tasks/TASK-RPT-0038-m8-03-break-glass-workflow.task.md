...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-break-glass-workflow.task.md"
  - "docs/ReportDemo/evidence/M8-03/**"
  - "src/ReportDemo.Admin/**"
  - "src/ReportDemo.Security/**"
  - "legacy/舊系統報表模組_功能別803.xxx"
  - "legacy/舊系統資料轉換_SP_功能別803.sql"
deliverables:
  - "docs/ReportDemo/evidence/M8-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M8-03/validation-result.md"

...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-go-no-go-gate.task.md"
  - "docs/ReportDemo/evidence/M9-02/**"
  - "infra/migration/reportdemo/**"
  - "runbooks/reportdemo/**"
  - "legacy/舊系統報表模組_功能別902.xxx"
  - "legacy/舊系統資料轉換_SP_功能別902.sql"
deliverables:
  - "docs/ReportDemo/evidence/M9-02/implementation-notes.md"
  - "docs/ReportDemo/evidence/M9-02/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m9.go-no-go-gate"
  mapUpdates:
...
---
# TASK-RPT-0040 - M9-02 建立 Go / No-Go Gate

## Goal

完成 `M9-02` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別902.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別902.sql`

---
task_id: TASK-RPT-0041
source_milestone: M9-03
title: "建立 Rollback Runbook"
status: planned
...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-rollback-runbook.task.md"
  - "docs/ReportDemo/evidence/M9-03/**"
  - "infra/migration/reportdemo/**"
  - "runbooks/reportdemo/**"
  - "legacy/舊系統報表模組_功能別903.xxx"
  - "legacy/舊系統資料轉換_SP_功能別903.sql"
deliverables:
  - "docs/ReportDemo/evidence/M9-03/implementation-notes.md"
  - "docs/ReportDemo/evidence/M9-03/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m9.rollback-runbook"
  mapUpdates:
...
---
# TASK-RPT-0041 - M9-03 建立 Rollback Runbook

## Goal

完成 `M9-03` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別903.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別903.sql`

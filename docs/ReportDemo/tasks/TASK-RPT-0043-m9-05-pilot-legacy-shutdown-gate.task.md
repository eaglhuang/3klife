...
scopePaths:
  - "docs/ReportDemo/tasks/TASK-RPT-*-pilot-legacy-shutdown-gate.task.md"
  - "docs/ReportDemo/evidence/M9-05/**"
  - "infra/migration/reportdemo/**"
  - "runbooks/reportdemo/**"
  - "legacy/舊系統報表模組_功能別905.xxx"
  - "legacy/舊系統資料轉換_SP_功能別905.sql"
deliverables:
  - "docs/ReportDemo/evidence/M9-05/implementation-notes.md"
  - "docs/ReportDemo/evidence/M9-05/validation-result.md"
...
atomizationImpact:
  ownerAtomOrMap: "reportdemo.m9.pilot-legacy-shutdown-gate"
  mapUpdates:
...
---
# TASK-RPT-0043 - M9-05 建立 Pilot 與舊系統下線 Gate

## Goal

完成 `M9-05` 對應功能，並能證明新系統涵蓋舊系統必要行為；未知舊系統程式碼先以象徵性代號標記，後續盤點時替換為真實名稱。

## Legacy Coverage

- 需對照：`legacy/舊系統報表模組_功能別905.xxx`
- 需對照：`legacy/舊系統資料轉換_SP_功能別905.sql`

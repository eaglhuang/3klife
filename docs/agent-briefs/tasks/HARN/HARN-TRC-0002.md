...
node tools_node/check-encoding-touched.js --files docs/agent-briefs/tasks/HARN/HARN-TRC-0002.md tools_node/lib/execution-trace-middleware.js tools_node/lib/context-guard-core.js
```

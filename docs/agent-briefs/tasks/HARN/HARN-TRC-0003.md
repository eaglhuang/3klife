...
node tools_node/check-encoding-touched.js --files docs/agent-briefs/tasks/HARN/HARN-TRC-0003.md tools_node/collect-execution-trace.js tests/fixtures/harness/execution-trace-smoke.jsonl
```

...
> See [UI-task-card-template.md](./UI-task-card-template.md (doc_task_0132)) (doc_task_0132).
...
| UI-2-0012 | Agent1 | done |  |  | skin-update | [UI-2-0012](./tasks/UI-2-0012.md (doc_task_0036)) (doc_task_0036) |
| UI-2-0004 | Agent1 | done |  |  | typography-token-update | [UI-2-0004](./tasks/UI-2-0004.md (doc_task_0028)) (doc_task_0028) |
| UI-2-0005 | Agent1 | done |  |  | runtime-support | [UI-2-0005](./tasks/UI-2-0005.md (doc_task_0029)) (doc_task_0029) |
| UI-2-0006 | Agent1 | done |  |  | validation | [UI-2-0006](./tasks/UI-2-0006.md (doc_task_0030)) (doc_task_0030) |
| UI-2-0007 | Agent1 | done |  |  | skin-upgrade | [UI-2-0007](./tasks/UI-2-0007.md (doc_task_0031)) (doc_task_0031) |
| UI-2-0013 | Agent1 | done |  |  | skin-upgrade | [UI-2-0013](./tasks/UI-2-0013.md (doc_task_0037)) (doc_task_0037) |
| UI-2-0014 | Agent1 | done |  |  | skin-upgrade | [UI-2-0014](./tasks/UI-2-0014.md (doc_task_0038)) (doc_task_0038) |
| UI-2-0015 | Agent1 | done |  |  | skin-upgrade | [UI-2-0015](./tasks/UI-2-0015.md (doc_task_0039)) (doc_task_0039) |
| UI-2-0008 | Agent1 | done |  |  | skin-fragment | [UI-2-0008](./tasks/UI-2-0008.md (doc_task_0032)) (doc_task_0032) |
| UI-2-0009 | Agent1 | done |  |  | skin-fragment | [UI-2-0009](./tasks/UI-2-0009.md (doc_task_0033)) (doc_task_0033) |
| UI-2-0010 | Agent1 | done |  |  | runtime-support | [UI-2-0010](./tasks/UI-2-0010.md (doc_task_0034)) (doc_task_0034) |
| UI-2-0011 | Agent1 | done |  |  | runtime-support | [UI-2-0011](./tasks/UI-2-0011.md (doc_task_0035)) (doc_task_0035) |
| UI-2-0016 | Agent1 | done |  |  | runtime-support | [UI-2-0016](./tasks/UI-2-0016.md (doc_task_0040)) (doc_task_0040) |
| UI-1-0005 | Agent2 | done |  |  | generate-sprites | [UI-1-0005](./tasks/UI-1-0005.md (doc_task_0013)) (doc_task_0013) |
| UI-1-0006 | Agent2 | done |  |  | generate-sprites | [UI-1-0006](./tasks/UI-1-0006.md (doc_task_0014)) (doc_task_0014) |
| UI-1-0007 | Agent2 | done |  |  | generate-sprites | [UI-1-0007](./tasks/UI-1-0007.md (doc_task_0015)) (doc_task_0015) |
| UI-1-0008 | Agent2 | done |  |  | generate-sprites | [UI-1-0008](./tasks/UI-1-0008.md (doc_task_0016)) (doc_task_0016) |
| UI-1-0009 | Agent2 | done |  |  | generate-sprites | [UI-1-0009](./tasks/UI-1-0009.md (doc_task_0017)) (doc_task_0017) |
| UI-1-0010 | Agent2 | done | P1 | A |  | [UI-1-0010](./tasks/UI-1-0010.md (doc_task_0018)) (doc_task_0018) |
| UI-1-0011 | Agent2 | done | P1 | A |  | [UI-1-0011](./tasks/UI-1-0011.md (doc_task_0019)) (doc_task_0019) |
| UI-1-0012 | Agent2 | done | P1 | A |  | [UI-1-0012](./tasks/UI-1-0012.md (doc_task_0020)) (doc_task_0020) |
...
| UI-2-0020 | Agent1 | done | P1 | B | skin-update | [UI-2-0020](./tasks/UI-2-0020.md (doc_task_0044)) (doc_task_0044) |
| UI-2-0021 | Agent1 | done | P0 | C | runtime-resource-fix | [UI-2-0021](./tasks/UI-2-0021.md (doc_task_0045)) (doc_task_0045) |
| UI-2-0022 | Agent1 | done | P1 | B | skin-update | [UI-2-0022](./tasks/UI-2-0022.md (doc_task_0046)) (doc_task_0046) |
| UI-2-0023 | Agent1 | done | P1 | C | qa-tooling | [UI-2-0023](./tasks/UI-2-0023.md (doc_task_0047)) (doc_task_0047) |
| UI-2-0025 | Agent1 | done | P1 | C | screen-contract-fix | [UI-2-0025](./tasks/UI-2-0025.md (doc_task_0049)) (doc_task_0049) |
| DATA-1-0001 | Agent1 | done | P1 | D | contract | [DATA-1-0001](./tasks/DATA-1-0001.md) |
| UI-2-0026 | Agent1 | in-progress | P1 | D | layout-fix | [UI-2-0026](./tasks/UI-2-0026.md) |
| UI-2-0027 | Agent2 | in-progress | P1 | D | asset-requirement | [UI-2-0027](./tasks/UI-2-0027.md (doc_task_0050)) (doc_task_0050) |
| UI-2-0031 | Agent2 | in-progress | P1 | D | policy | [UI-2-0031](./tasks/UI-2-0031.md (doc_task_0054)) (doc_task_0054) |
| UI-2-0030 | Agent2 | in-progress | P1 | D | asset-requirement | [UI-2-0030](./tasks/UI-2-0030.md (doc_task_0053)) (doc_task_0053) |
...
| UI-2-0034 | Agent1 | done | P1 | D | runtime-support | [UI-2-0034](./tasks/UI-2-0034.md (doc_task_0057)) (doc_task_0057) |
| UI-2-0043 | Agent1 | done | P1 | D | asset-generation | [UI-2-0043](./tasks/UI-2-0043.md (doc_task_0066)) (doc_task_0066) |
| UI-2-0044 | Agent1 | in-progress | P1 | D | asset-generation | [UI-2-0044](./tasks/UI-2-0044.md (doc_task_0067)) (doc_task_0067) |
| UI-2-0045 | Agent1 | in-progress | P1 | D | asset-generation | [UI-2-0045](./tasks/UI-2-0045.md (doc_task_0068)) (doc_task_0068) |
| UI-2-0047 | Agent2 | done | P1 | D | asset-direction | [UI-2-0047](./tasks/UI-2-0047.md (doc_task_0070)) (doc_task_0070) |
| UI-2-0048 | Agent2 | done | P1 | D | asset-direction | [UI-2-0048](./tasks/UI-2-0048.md (doc_task_0071)) (doc_task_0071) |
| UI-2-0049 | Agent2 | done | P1 | D | asset-direction | [UI-2-0049](./tasks/UI-2-0049.md (doc_task_0072)) (doc_task_0072) |
| UI-2-0050 | Agent2 | done | P1 | D | asset-direction | [UI-2-0050](./tasks/UI-2-0050.md (doc_task_0073)) (doc_task_0073) |
| UI-2-0051 | Agent2 | done | P1 | D | qa-pipeline | [UI-2-0051](./tasks/UI-2-0051.md (doc_task_0074)) (doc_task_0074) |
| UI-2-0052 | Agent2 | done | P1 | D | asset-direction | [UI-2-0052](./tasks/UI-2-0052.md (doc_task_0075)) (doc_task_0075) |
...
| UI-2-0092 | Agent1 | open | P1 | G | asset-generation | [UI-2-0092](./tasks/UI-2-0092.md (doc_task_0115)) (doc_task_0115) |
| UI-2-0093 | Agent2 | in-progress | P1 | G | layout-content-polish | [UI-2-0093](./tasks/UI-2-0093.md (doc_task_0116)) (doc_task_0116) |
...
| PROG-1-0003 | Agent1 | open | P0 | P | data-structure | [PROG-1-0003](./tasks/PROG-1-0003.md) |
| PROG-1-0004 | Agent1 | open | P0 | P | data-structure | [PROG-1-0004](./tasks/PROG-1-0004.md) |
| PROG-1-0005 | Agent1 | open | P0 | P | data-structure | [PROG-1-0005](./tasks/PROG-1-0005.md) |
| PROG-1-0006 | Agent1 | open | P0 | P | data-structure | [PROG-1-0006](./tasks/PROG-1-0006.md) |
...
| DC-1-0001 | Agent1 | done | P0 | DC | tooling | [DC-1-0001](./tasks/DC-1-0001.md) |
| DC-1-0002 | Agent1 | done | P0 | DC | tooling | [DC-1-0002](./tasks/DC-1-0002.md) |
| DC-1-0003 | Agent1 | done | P0 | DC | tooling | [DC-1-0003](./tasks/DC-1-0003.md) |
| DC-1-0004 | Agent1 | done | P1 | DC | tooling | [DC-1-0004](./tasks/DC-1-0004.md) |
| DC-1-0005 | Agent1 | done | P1 | DC | tooling | [DC-1-0005](./tasks/DC-1-0005.md) |
| DC-1-0006 | Agent1 | done | P1 | DC | content | [DC-1-0006](./tasks/DC-1-0006.md) |
| DC-1-0007 | Agent1 | done | P1 | DC | documentation | [DC-1-0007](./tasks/DC-1-0007.md) |
| DC-2-0001 | Agent1 | done | P1 | DC | feature | [DC-2-0001](./tasks/DC-2-0001.md) |
| DC-2-0002 | Agent1 | done | P1 | DC | feature | [DC-2-0002](./tasks/DC-2-0002.md) |
| DC-2-0003 | Agent1 | done | P1 | DC | feature | [DC-2-0003](./tasks/DC-2-0003.md) |
| DC-2-0004 | Agent1 | done | P1 | DC | feature | [DC-2-0004](./tasks/DC-2-0004.md) |
| DC-2-0005 | Agent1 | done | P1 | DC | feature | [DC-2-0005](./tasks/DC-2-0005.md) |
| DC-2-0006 | Agent1 | done | P2 | DC | testing | [DC-2-0006](./tasks/DC-2-0006.md) |
| DC-3-0001 | Agent1 | done | P1 | DC | data-structure | [DC-3-0001](./tasks/DC-3-0001.md) |
| DC-3-0002 | Agent1 | done | P1 | DC | feature | [DC-3-0002](./tasks/DC-3-0002.md) |
| DC-3-0003 | Agent1 | done | P1 | DC | tooling | [DC-3-0003](./tasks/DC-3-0003.md) |
| DC-3-0004 | Agent1 | done | P2 | DC | feature | [DC-3-0004](./tasks/DC-3-0004.md) |
| DC-3-0005 | Agent1 | done | P1 | DC | tooling | [DC-3-0005](./tasks/DC-3-0005.md) |
| DC-4-0001 | Agent1 | done | P2 | DC | feature | [DC-4-0001](./tasks/DC-4-0001.md) |
| DC-4-0002 | Agent1 | done | P2 | DC | feature | [DC-4-0002](./tasks/DC-4-0002.md) |
| DC-4-0003 | Agent1 | done | P2 | DC | feature | [DC-4-0003](./tasks/DC-4-0003.md) |
| DC-5-0001 | Agent1 | done | P2 | DC | feature | [DC-5-0001](./tasks/DC-5-0001.md) |
| DC-5-0002 | Agent1 | done | P2 | DC | feature | [DC-5-0002](./tasks/DC-5-0002.md) |
| DC-5-0003 | Agent1 | done | P2 | DC | documentation | [DC-5-0003](./tasks/DC-5-0003.md) |
| DC-5-0004 | Agent1 | done | P2 | DC | feature | [DC-5-0004](./tasks/DC-5-0004.md) |
| DC-5-0005 | Agent1 | done | P2 | DC | feature | [DC-5-0005](./tasks/DC-5-0005.md) |
| DC-6-0001 | Agent1 | done | P2 | DC | content | [DC-6-0001](./tasks/DC-6-0001.md) |
| DC-6-0002 | Agent1 | done | P2 | DC | feature | [DC-6-0002](./tasks/DC-6-0002.md) |
| DC-6-0003 | Agent1 | done | P2 | DC | feature | [DC-6-0003](./tasks/DC-6-0003.md) |

...
| Phase C dual-live FastAPI conflict | use run id rather than framework commit | host-side run artifact: `C:/Users/User/3klife-npc-brain/.atm/history/evidence/broker-runs/6ea4e411-fa2b-426b-9c71-55bbdbeaa888.json` | **re-verified from the original host branch artifact in this workspace** | Keep as host-evidence line and avoid overclaim |
...
- Phase C has now been re-verified against the host-side broker-run envelope at `C:/Users/User/3klife-npc-brain/.atm/history/evidence/broker-runs/6ea4e411-fa2b-426b-9c71-55bbdbeaa888.json`.

...
\textbf{Reading note for Figure 1.} The three subgraphs map to the §3.1 planes as follows:
...
\textbf{Table 1 --- Governance Object Comparison.}
...
\textbf{Table 2 --- Broker Verdicts and Follow-Up Paths.}
...
\textbf{Escalation examples for Figure 3.} To prevent the three escalation triggers---shared surface, shared artifact, and governed scope---from remaining abstract, the paper gives three typical escalation scenarios and one non-escalation contrast:
...
\textbf{Table 5 --- Deterministic Fixture Coverage Categories.}
...
\textbf{Table 6 --- npc-brain Three-Week Adoption Summary.}
...
\textbf{Table 7 --- Separated Evidence Lines for Public-Source and Structured-Artifact Governance.}
...
\textbf{Table 8 --- Baseline Policy Definitions.}
...
\textbf{Table 9 --- ATM-AdmissionBench v0.1 Baseline versus v0.2 Paper Profile.}
...
\textbf{Table 10 --- ATM-AdmissionBench v0.2 Paper-Facing Summary.}
...
\textbf{Table 11 --- OperationalBench Latency Summary.}
...
\textbf{Table 12 --- Compact Research-Question Status Summary.}
...
\textbf{Table A.1 --- Compact Evidence Artifact Index.}
...
\textbf{Table A.2 --- Compact Verification Map.}
...
\textbf{Table A.3 --- Topology C Implementation Stages.}
...
\textbf{Table A.4 --- Public Artifact Manifest Snapshot.}
...
\textbf{Table C.1 --- Release Anchor Summary.}

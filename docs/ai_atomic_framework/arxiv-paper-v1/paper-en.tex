...
\scriptsize
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{}L{0.12\textwidth}L{0.12\textwidth}L{0.12\textwidth}L{0.12\textwidth}L{0.12\textwidth}L{0.12\textwidth}L{0.12\textwidth}@{}}
\toprule
...
\draw[dashflow] (EB.east) -- ++(0.4,0) |- node[lbl, near end, above]{evidence feedback} (B.south east);
% (b) post-write validators: validator envelope -> agent
\draw[dashflow] (VE.west) -- ++(-0.6,0) |- node[lbl, near end, above]{post-write validators} (ADAP.west);
...
\node[mech]  (B1) at (-7.5,-3.7) {Mechanism\\\tiny §4.1 \,/\, 12-scenario\\\tiny B-02 / B-08 / B-13};
\node[self]  (B2) at (-4.5,-3.7) {Self-hosting\\\tiny §4.2 \,/\, forensics\\\tiny coverage 95\,/\,100};
\node[adopt] (B3) at (-1.5,-3.7) {Adoption\\\tiny §4.3 \,/\, npc-brain\\\tiny recoverability};
\node[field] (B4) at ( 1.5,-3.7) {Field collision\\\tiny §4.4 \,/\, same-file\\\tiny POS2 / B-12 / BLOCK};
\node[bench] (B5) at ( 4.5,-3.7) {AdmissionBench\\\tiny §5 \,/\, v0.1 baseline\\\tiny + v0.2 paper};
\node[wave]  (B6) at ( 7.5,-3.7) {Wave / Batch\\\tiny §4.5 \,/\, extension\\\tiny orchestration};
...
\textbf{Table 11 --- Separated Evidence Lines for Public-Source and Structured-Artifact Governance.}
...
\textbf{Table 19b --- OperationalBench Latency Summary.}
...
\textbf{Table 20 --- Benchmark Research Questions and Current Evidence.}
...
RQ8: Operational overhead and recovery routing & What runtime cost does ATM introduce, and what happens after blocked or fail-closed admission? & OperationalBench reports the paper-facing operational profile, an \texttt{\seqsplit{N=50}} extended contention run, and multi-seed stability runs. These runs distinguish unsafe direct-apply prevention from loss of agent work by recording recovery-routing behavior, including steward-mediated paths and total scenario time. Multi-seed stability further shows that \texttt{\seqsplit{scenarioCount}}, \texttt{\seqsplit{resultRows}}, \texttt{\seqsplit{trackCounts}}, \texttt{\seqsplit{blockedCaseCounts}}, \texttt{\seqsplit{routeCounts}}, and the recovery metrics remain stable across the tested seeds. & Heavier validator-pressure variants, public-repository operational smoke tests, and larger high-contention runs with queue-wait, token-rework, and bounded-waiting metrics. \\
\bottomrule
\end{longtable}
\endgroup
...
\begin{quote}
\textbf{Canonical anchor rule.} The canonical public anchor for the AdmissionBench paper-facing numbers is \texttt{\seqsplit{artifacts/generated/atm-admission-bench/20260625-paper/}} under ATM public repository \texttt{\seqsplit{main@ab8753b7daf0a3c4cd8b4483fe24d519ff2590bd}}. The canonical public anchor for the OperationalBench paper-facing numbers and supplementary stability evidence is \texttt{\seqsplit{main@c0250009a53b28e887344e71ea675637c97290b0}}, covering the official 2026-06-27 run (\texttt{\seqsplit{artifacts/generated/atm-operational-bench/20260627/}}), the extended 2026-06-27 \texttt{\seqsplit{N=50}} run (\texttt{\seqsplit{artifacts/generated/atm-operational-bench/20260627-extended/}}), and the multi-seed stability note (\texttt{\seqsplit{artifacts/generated/atm-operational-bench/multi-seed-stability-20260627-20260629.\{md,json\}}}). The \texttt{\seqsplit{v0.9.0-alpha.1}} source snapshot and the generator or evidence commits recorded in the benchmark artifacts remain important, but they serve different roles from the public artifact anchors and should not be conflated with them.
\end{quote}

\begin{itemize}
\item \textbf{Public.} The source of the ATM framework itself, the deterministic-runner MVP, the 12-scenario fixture design, the ATM-AdmissionBench v0.1 baseline artifacts, the ATM-AdmissionBench v0.2 paper-profile artifacts, the OperationalBench official and supplementary artifacts, the broker decision implementation, the CID validation scripts, the Topology C bridge, and most self-hosting governance reports are stored in the public GitHub repository \texttt{\seqsplit{eaglhuang/AI-Atomic-Framework}}. The source-reference snapshot of this manuscript is release tag \texttt{\seqsplit{v0.9.0-alpha.1}}, corresponding to commit \texttt{\seqsplit{0b31aa8683b44b3a78206132a0bf90a0fde73d1c}}. The machine-generated source anchor for both the AdmissionBench v0.1 baseline and the v0.2 paper profile is the generator commit \texttt{\seqsplit{3eec69a73a04112e2af8d3630c32138c37143eab}}, as recorded in their \texttt{\seqsplit{generator-manifest.json}} files. Reviewers who wish to verify the AdmissionBench numbers in this paper item by item should first open \texttt{\seqsplit{artifacts/generated/atm-admission-bench/20260625-paper/}} under \texttt{\seqsplit{main@ab8753b7daf0a3c4cd8b4483fe24d519ff2590bd}} in the ATM public repository, and then cross-check using its \texttt{\seqsplit{generator-manifest.json}}, \texttt{\seqsplit{summary.json}}, \texttt{\seqsplit{paper-tables.md}}, \texttt{\seqsplit{artifact-hash-manifest.sha256}}, and the matching \texttt{\seqsplit{20260625/}} baseline directory. Reviewers who wish to verify the OperationalBench numbers should instead open the official 2026-06-27 run (\texttt{\seqsplit{20260627}}), the extended 2026-06-27 \texttt{\seqsplit{N=50}} run (\texttt{\seqsplit{20260627-extended}}), and the multi-seed stability artifacts under \texttt{\seqsplit{main@c0250009a53b28e887344e71ea675637c97290b0}}.
...
ATM-OperationalBench v0.1 official run + supplementary evidence & Machine-generated operational-overhead, recovery-routing, higher-contention, and seed-stability evidence & Canonical public anchor: \texttt{\seqsplit{main@c0250009a53b28e887344e71ea675637c97290b0}} $\rightarrow$ \texttt{\seqsplit{artifacts/generated/atm-operational-bench/20260627/}}; secondary anchors: \texttt{\seqsplit{artifacts/generated/atm-operational-bench/20260627-extended/}}, \texttt{\seqsplit{artifacts/generated/atm-operational-bench/multi-seed-stability-20260627-20260629.md}}, \texttt{\seqsplit{artifacts/generated/atm-operational-bench/multi-seed-stability-20260627-20260629.json}} & Public (ATM repository and supplementary release); operational evidence only, not a cross-system performance benchmark \\
Framework mainline broker-evidence support & Shows that broker evidence capture and repo-local evidence-path parameterization have landed in the ATM framework mainline & Paper-evidence fast-path bundle \texttt{\seqsplit{191fd310166054d3fa526b6961351716bb2d489e}}; git-head backfill commit for this evidence freeze \texttt{\seqsplit{f57dbfe0bdfdf9f939e35400ec346501f4ccb2f3}} & Public ATM repository \\
FastAPI public-source snapshot governance case & Public-source snapshot provenance, baseline, readiness, touched-path, command-log, and replay evidence inside the host repository & \texttt{\seqsplit{artifacts/external-public-repo/fastapi/2026-06-27/summary.json}}, \texttt{\seqsplit{paper-safe-summary.md}}, \texttt{\seqsplit{commands.log}}; upstream snapshot head \texttt{\seqsplit{82064857539e6286522c347b4b11331b48dd2378}}; host head \texttt{\seqsplit{738b9883880742cd36b64f1f81ce6a638f073135}} & Host-repository evidence bundle; released as paper-safe summary and supplementary artifact \\
Structured Artifact Admission Track & Deterministic cross-format admission evidence for structured non-code artifacts & \texttt{\seqsplit{artifacts/generated/structured-artifact-admission/20260627-phase-b/summary.json}}, \texttt{\seqsplit{paper-safe-summary.md}}, \texttt{\seqsplit{results.jsonl}}, \texttt{\seqsplit{docs/reports/structured-artifact-admission-track-2026-06-27.md}} & Public ATM repository and supplementary release \\
Dual-live external public-source conflict demonstration & Team Broker mode evidence for two live actors touching the same FastAPI public-source snapshot path & Host-side broker-run envelope \texttt{\seqsplit{.atm/history/evidence/broker-runs/6ea4e411-fa2b-426b-9c71-55bbdbeaa888.json}}; plan id \texttt{\seqsplit{batch-5c1fd53c988116ce}} & Re-verified host-repository evidence bundle; paper-safe summary or de-identified supplementary artifact \\
Cross-agent review signature prototype & Evidence-closure prototype showing that independent AI review can be represented as replayable closure evidence & \texttt{\seqsplit{artifacts/generated/cross-agent-review-signature/20260628/}}; landed at commit \texttt{\seqsplit{c589f125049ad81adc146f1b78e6a5ee36b8f607}} & Public ATM repository \\
Reviewer-facing last-verified manifest & Framework verification support showing that selected reviewer-facing commands were executed and recorded for the evidence freeze & \texttt{\seqsplit{artifacts/verification/last-verified.json}}; landed on \texttt{\seqsplit{main}} at commit \texttt{\seqsplit{7a88af7d3db0be6d7e1b4c59f46706eabc5808a2}} & Public ATM repository \\
Adversarial adapter containment package & Deterministic local containment evidence for selected adapter-trust boundary cases, including malformed scope declarations, conservative shared-surface blocking, validator-backed dependency detection, and CAS-mismatch recovery & \texttt{\seqsplit{artifacts/adversarial-adapter-containment/20260628/summary.json}}, \texttt{\seqsplit{results.jsonl}}, \texttt{\seqsplit{paper-safe-summary.md}}, and \texttt{\seqsplit{artifact-hash-manifest.sha256}}; landed on \texttt{\seqsplit{main}} at commit \texttt{\seqsplit{7a88af7d3db0be6d7e1b4c59f46706eabc5808a2}} & Public ATM repository \\
...
Steward arbitration and fail-closed apply routing & \texttt{\seqsplit{packages/core/src/broker/steward.ts}} & \texttt{\seqsplit{npm test -- broker/steward}} \\
...
§5 OperationalBench runtime overhead and recovery routing & \texttt{\seqsplit{docs/bench/ATM-OperationalBench-CONTRACT.md}}, \texttt{\seqsplit{scripts/run-atm-operational-bench.ts}}, \texttt{\seqsplit{scripts/validate-operational-bench.ts}}, \texttt{\seqsplit{scripts/lib/operational-bench/runner.ts}}, \texttt{\seqsplit{scripts/lib/operational-bench/scenarios.ts}} & \texttt{\seqsplit{npm run bench:operational:paper -- --seed 20260627}}; \texttt{\seqsplit{npm run bench:operational:extended -- --seed 20260627 --out artifacts/generated/atm-operational-bench/20260627-extended}}; \texttt{\seqsplit{npm run bench:operational:paper -- --seed 20260628 --out artifacts/generated/atm-operational-bench/20260628}}; \texttt{\seqsplit{npm run bench:operational:paper -- --seed 20260629 --out artifacts/generated/atm-operational-bench/20260629}}; \texttt{\seqsplit{npm run validate:operational-bench}} \\
Framework mainline broker evidence capture and repo-local evidence-path parameterization & Paper-evidence fast-path bundle \texttt{\seqsplit{191fd310166054d3fa526b6961351716bb2d489e}}; git-head backfill commit for this evidence freeze \texttt{\seqsplit{f57dbfe0bdfdf9f939e35400ec346501f4ccb2f3}} & Inspect the framework commits and replay broker evidence capture using the repo-local evidence path configured for the current repository \\
Phase A FastAPI public-source snapshot governance case & \texttt{\seqsplit{artifacts/external-public-repo/fastapi/2026-06-27/summary.json}}, \texttt{\seqsplit{paper-safe-summary.md}}, \texttt{\seqsplit{commands.log}}; touched paths \texttt{\seqsplit{local/public-source-snapshots/fastapi-0.136.3/fastapi/\_\_init\_\_.py}} and \texttt{\seqsplit{app/main.py}} & Read \texttt{\seqsplit{summary.json}} and \texttt{\seqsplit{commands.log}}; verify upstream snapshot head \texttt{\seqsplit{82064857539e6286522c347b4b11331b48dd2378}}, host head \texttt{\seqsplit{738b9883880742cd36b64f1f81ce6a638f073135}}, and replay evidence. Boundary: do not treat this as upstream maintainer workflow governance or clean post-change snapshot-helper execution evidence \\
Phase B Structured Artifact Admission Track & \texttt{\seqsplit{artifacts/generated/structured-artifact-admission/20260627-phase-b/summary.json}}, \texttt{\seqsplit{paper-safe-summary.md}}, \texttt{\seqsplit{results.jsonl}}, \texttt{\seqsplit{docs/reports/structured-artifact-admission-track-2026-06-27.md}} & Verify \texttt{\seqsplit{matchedCount = 15}}, \texttt{\seqsplit{shipSafe = true}}, and decision distribution of 5 \texttt{\seqsplit{parallel-safe}}, 5 \texttt{\seqsplit{blocked-cid-conflict}}, and 5 \texttt{\seqsplit{serial}} outcomes across JSON, YAML, TOML, OpenAPI, and atom-map shard families \\
Phase C dual-live external public-source conflict demonstration & Host-side broker-run envelope \texttt{\seqsplit{.atm/history/evidence/broker-runs/6ea4e411-fa2b-426b-9c71-55bbdbeaa888.json}} & Verify run id \texttt{\seqsplit{6ea4e411-fa2b-426b-9c71-55bbdbeaa888}}, plan id \texttt{\seqsplit{batch-5c1fd53c988116ce}}, actors \texttt{\seqsplit{cursor-composer-2.5}} and \texttt{\seqsplit{antigravity-gemini-3.5-flash}}, target \texttt{\seqsplit{local/public-source-snapshots/fastapi-0.136.3/fastapi/\_\_init\_\_.py}}, and outcomes \texttt{\seqsplit{applied / mergeable}} versus \texttt{\seqsplit{queued / conflict}} \\
Cross-agent review signatures as Evidence-closure prototype evidence & \texttt{\seqsplit{artifacts/generated/cross-agent-review-signature/20260628/}}; commit \texttt{\seqsplit{c589f125049ad81adc146f1b78e6a5ee36b8f607}} & Inspect the generated review-signature artifacts and verify that they record reviewer identity, model/source metadata, reviewed diff hash, rubric or verdict fields, and closure-evidence linkage. Boundary: this is prototype evidence for review-signature capture, not a proof of semantic correctness and not a completed quorum-review evaluation. \\
Reviewer-facing verification commands were recorded for the evidence freeze & \texttt{\seqsplit{artifacts/verification/last-verified.json}}; commit \texttt{\seqsplit{7a88af7d3db0be6d7e1b4c59f46706eabc5808a2}} & Inspect \texttt{\seqsplit{last-verified.json}} and confirm that the recorded reviewer-facing verification commands completed successfully. Boundary: this is reproducibility support for selected commands, not a comprehensive proof that every repository path or every deployment topology has been verified. \\
Selected adversarial adapter-boundary cases are contained by fail-closed or replay-oriented recovery paths & \texttt{\seqsplit{artifacts/adversarial-adapter-containment/20260628/summary.json}}, \texttt{\seqsplit{results.jsonl}}, \texttt{\seqsplit{paper-safe-summary.md}}, and \texttt{\seqsplit{artifact-hash-manifest.sha256}}; commit \texttt{\seqsplit{7a88af7d3db0be6d7e1b4c59f46706eabc5808a2}} & Verify the five deterministic local cases and confirm that malformed scope declarations, conservative shared-surface blocking, validator-backed dependency detection, and CAS-mismatch recovery remain within fail-closed or replay-oriented recovery boundaries. Boundary: this is containment evidence for selected cases, not adversarial adapter soundness or completeness. \\
...
The supplementary data archive is source-aligned with \texttt{\seqsplit{v0.9.0-alpha.1}} but uses the later AdmissionBench and OperationalBench evidence-landing commits for benchmark artifacts. It contains eight categories of material. Categories 1--4 are publicly reproducible mechanism and benchmark evidence; categories 5--8 are field and methodology evidence released in de-identified form.
...
\item \textbf{ATM-OperationalBench official and supplementary artifacts.} The paper-facing operational profile is the official 2026-06-27 run (\texttt{\seqsplit{artifacts/generated/atm-operational-bench/20260627/}}), and the supplementary evidence consists of the extended 2026-06-27 \texttt{\seqsplit{N=50}} run (\texttt{\seqsplit{artifacts/generated/atm-operational-bench/20260627-extended/}}) plus \texttt{\seqsplit{artifacts/generated/atm-operational-bench/multi-seed-stability-20260627-20260629.md}} and \texttt{\seqsplit{.json}}, all under ATM public repository \texttt{\seqsplit{main}} commit \texttt{\seqsplit{c0250009a53b28e887344e71ea675637c97290b0}}. Together these artifacts expose ATM-local operational overhead, the \texttt{\seqsplit{N=50}} higher-contention tail, and the multi-seed stability of the route and recovery structure. They are cited only as operational transparency and recovery-routing evidence, not as an external comparative benchmark.

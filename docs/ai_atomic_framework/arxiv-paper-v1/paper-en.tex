...
\textbf{Table 1 --- Selected System Boundary Matrix.}
...
\textbf{Table 2 --- Governance Object Comparison.}
...
\textbf{Table 3 --- Broker Verdicts and Follow-Up Paths.}
...
\textbf{Table 4 --- Seven-Layer Admission Gate (with maturity markers).} The maturity column uses three labels:
...
\textbf{Table 5 --- ConflictKey Generalization Matrix.} Scope $\times$ Locator mapping across formats.
...
\textbf{Table 6 --- Deterministic Fixture Coverage Categories.}
...
\textbf{Table 7 --- npc-brain Three-Week Adoption Summary.}
...
\textbf{Table 8 --- Separated Evidence Lines for Public-Source and Structured-Artifact Governance.}
...
\textbf{Table 9 --- Baseline Policy Definitions.}
...
\textbf{Table 10 --- ATM-AdmissionBench v0.1 Baseline versus v0.2 Paper Profile.}
...
\textbf{Table 11 --- ATM-AdmissionBench v0.2 Paper-Facing Summary.}
...
\textbf{Table 12 --- OperationalBench Latency Summary.}
...
\textbf{Table 13 --- Compact Research-Question Status Summary.}

...
\begin{longtable}{@{}L{0.29\textwidth}L{0.29\textwidth}L{0.29\textwidth}@{}}
\toprule
...
\begin{tikzpicture}[
  ...
  lbl/.style   ={font=\tiny\itshape, fill=white,    inner sep=1pt},   % open / white-page space
  lblma/.style ={font=\tiny\itshape, fill=green!12, inner sep=1pt},   % over Mutation-admission plane
  lbltc/.style ={font=\tiny\itshape, fill=blue!10,  inner sep=1pt},   % over Task-contract plane
  lblec/.style ={font=\tiny\itshape, fill=orange!14,inner sep=1pt}    % over Evidence-closure plane
]
...
\draw[flow] (B)       -- node[lblma, above]{verdict + plan} (ST);
\draw[flow] (ST.south) -- ++(0,-1.4) -| (CP.north);
\draw[flow] (VE)      -- (EB);
\draw[flow] (EB)      -- (CP);
% --- Non-blocking dashed feedback channels (caption (a),(b),(c)) ---
% (a) evidence feedback: substrate -> broker
\draw[dashflow] (EB.east) -- ++(0.4,0) |- node[lblma, near end, above]{evidence feedback} (B.south east);
% (b) post-write validators: validator envelope -> agent
\draw[dashflow] (VE.west) -- ++(-0.6,0) |- node[lblma, near end, above]{post-write validators} (ADAP.west);
...
\draw[dashflow] (CP.south) -- ++(0,-0.5) -| node[lbl, pos=0.25, right]{epoch update on scope change}
                ([xshift=-3mm]HU.south) |- (T.west);
\end{tikzpicture}
\end{figure}
...
\arrayrulecolor{black!55}
\rowcolors{2}{gray!8}{white}
\begin{longtable}{@{}L{0.17\textwidth}L{0.17\textwidth}L{0.17\textwidth}L{0.17\textwidth}L{0.17\textwidth}@{}}
\toprule
...
\Needspace{14\baselineskip}\noindent\textbf{Figure 2 --- Progressive Atomization Admission Flow.}The figure shows how ATM exposes the relevant conflict boundary by progressing from coarse to fine granularity:
...
\textbf{Table 3 --- Seven-Layer Admission Gate (with maturity markers).} The maturity column uses three labels:
...
\arrayrulecolor{black!55}
\rowcolors{2}{gray!8}{white}
\begin{longtable}{@{}L{0.14\textwidth}L{0.14\textwidth}L{0.14\textwidth}L{0.14\textwidth}L{0.14\textwidth}L{0.14\textwidth}@{}}
\toprule
...
\textbf{Table 4 --- ConflictKey Generalization Matrix.} Scope $\times$ Locator mapping across formats.
...
\arrayrulecolor{black!55}
\rowcolors{2}{gray!8}{white}
\begin{longtable}{@{}L{0.21\textwidth}L{0.21\textwidth}L{0.21\textwidth}L{0.21\textwidth}@{}}
\toprule

...
| Phase C: Dual-live public-source conflict demonstration | ATM broker activates under Team Broker mode when two live actors touch the same FastAPI public-source snapshot path and records an auditable applied / queued / conflict run | `.atm/history/evidence/broker-runs/d66566dc-d055-41db-87cc-939aa27e0910.json`; plan id `batch-5c1fd53c988116ce`; target `local/public-source-snapshots/fastapi-0.136.3/fastapi/__init__.py` | Demonstrates one live conflict route; does not claim all runtime races are solved and does not claim upstream repo governance |
...
| Dual-live external public-source conflict demonstration                          | Team Broker mode evidence for two live actors touching the same FastAPI public-source snapshot path                                    | `.atm/history/evidence/broker-runs/d66566dc-d055-41db-87cc-939aa27e0910.json`; plan id `batch-5c1fd53c988116ce`                                                                                                                                                         | Host-repository evidence bundle; paper-safe summary or de-identified supplementary artifact                                                  |
...
| Phase C dual-live external public-source conflict demonstration | `.atm/history/evidence/broker-runs/d66566dc-d055-41db-87cc-939aa27e0910.json` | Verify run id `d66566dc-d055-41db-87cc-939aa27e0910`, plan id `batch-5c1fd53c988116ce`, actors `codex-gpt-5.4-mini` and `antigravity-gemini-3.5-flash`, target `local/public-source-snapshots/fastapi-0.136.3/fastapi/__init__.py`, and outcomes `applied / mergeable` versus `queued / conflict` |

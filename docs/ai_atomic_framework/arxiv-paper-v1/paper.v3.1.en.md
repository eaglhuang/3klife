...
| RQ6: Adapter trust boundary   | When the adapter under-reports or declares maliciously, how much can the other layers recover?           | Current field evidence, v0.2 adversarial rows, and a follow-up adversarial-adapter-containment package show that malformed scope declarations, conservative shared-surface blocking, validator-backed dependency detection, and CAS-mismatch recovery remain bounded within fail-closed or replay-oriented recovery paths under deterministic local checks. This evidence supports containment behavior for selected adapter-trust boundary cases; it does not establish adversarial adapter soundness, completeness, or a general guarantee over all malformed declarations. | Expanding the adversarial injection family to measure silent corruption, validator salvage, CAS salvage, and denial of service. |
...
| Framework mainline broker-evidence support                                       | Shows that broker evidence capture and repo-local evidence-path parameterization have landed in the ATM framework mainline             | Paper-evidence fast-path bundle `191fd310166054d3fa526b6961351716bb2d489e`; git-head backfill commit for this evidence freeze `f57dbfe0bdfdf9f939e35400ec346501f4ccb2f3`                                                                                                          | Public ATM repository                                                                                                                        |
...
| Dual-live external public-source conflict demonstration                          | Team Broker mode evidence for two live actors touching the same FastAPI public-source snapshot path                                    | Host-side broker-run envelope `.atm/history/evidence/broker-runs/6ea4e411-fa2b-426b-9c71-55bbdbeaa888.json`; plan id `batch-5c1fd53c988116ce`                                                                                                                          | Re-verified host-repository evidence bundle; paper-safe summary or de-identified supplementary artifact                                     |
| Cross-agent review signature prototype                                           | Evidence-closure prototype showing that independent AI review can be represented as replayable closure evidence                        | `artifacts/generated/cross-agent-review-signature/20260628/`; landed at commit `c589f125049ad81adc146f1b78e6a5ee36b8f607`                                                                                                                                               | Public ATM repository                                                                                                                        |
| Reviewer-facing last-verified manifest                                           | Framework verification support showing that selected reviewer-facing commands were executed and recorded for the evidence freeze       | `artifacts/verification/last-verified.json`; landed on `main` at commit `7a88af7d3db0be6d7e1b4c59f46706eabc5808a2`                                                                                                                                                      | Public ATM repository                                                                                                                        |
| Adversarial adapter containment package                                          | Deterministic local containment evidence for selected adapter-trust boundary cases, including malformed scope declarations, conservative shared-surface blocking, validator-backed dependency detection, and CAS-mismatch recovery | `artifacts/adversarial-adapter-containment/20260628/summary.json`, `results.jsonl`, `paper-safe-summary.md`, and `artifact-hash-manifest.sha256`; landed on `main` at commit `7a88af7d3db0be6d7e1b4c59f46706eabc5808a2`                                                         | Public ATM repository                                                                                                                        |
...
| Framework mainline broker evidence capture and repo-local evidence-path parameterization | Paper-evidence fast-path bundle `191fd310166054d3fa526b6961351716bb2d489e`; git-head backfill commit for this evidence freeze `f57dbfe0bdfdf9f939e35400ec346501f4ccb2f3` | Inspect the framework commits and replay broker evidence capture using the repo-local evidence path configured for the current repository |
...
| Phase C dual-live external public-source conflict demonstration | Host-side broker-run envelope `.atm/history/evidence/broker-runs/6ea4e411-fa2b-426b-9c71-55bbdbeaa888.json` | Verify run id `6ea4e411-fa2b-426b-9c71-55bbdbeaa888`, plan id `batch-5c1fd53c988116ce`, actors `cursor-composer-2.5` and `antigravity-gemini-3.5-flash`, target `local/public-source-snapshots/fastapi-0.136.3/fastapi/__init__.py`, and outcomes `applied / mergeable` versus `queued / conflict` |
| Cross-agent review signatures as Evidence-closure prototype evidence | `artifacts/generated/cross-agent-review-signature/20260628/`; commit `c589f125049ad81adc146f1b78e6a5ee36b8f607` | Inspect the generated review-signature artifacts and verify that they record reviewer identity, model/source metadata, reviewed diff hash, rubric or verdict fields, and closure-evidence linkage. Boundary: this is prototype evidence for review-signature capture, not a proof of semantic correctness and not a completed quorum-review evaluation. |
| Reviewer-facing verification commands were recorded for the evidence freeze | `artifacts/verification/last-verified.json`; commit `7a88af7d3db0be6d7e1b4c59f46706eabc5808a2` | Inspect `last-verified.json` and confirm that the recorded reviewer-facing verification commands completed successfully. Boundary: this is reproducibility support for selected commands, not a comprehensive proof that every repository path or every deployment topology has been verified. |
| Selected adversarial adapter-boundary cases are contained by fail-closed or replay-oriented recovery paths | `artifacts/adversarial-adapter-containment/20260628/summary.json`, `results.jsonl`, `paper-safe-summary.md`, and `artifact-hash-manifest.sha256`; commit `7a88af7d3db0be6d7e1b4c59f46706eabc5808a2` | Verify the five deterministic local cases and confirm that malformed scope declarations, conservative shared-surface blocking, validator-backed dependency detection, and CAS-mismatch recovery remain within fail-closed or replay-oriented recovery boundaries. Boundary: this is containment evidence for selected cases, not adversarial adapter soundness or completeness. |

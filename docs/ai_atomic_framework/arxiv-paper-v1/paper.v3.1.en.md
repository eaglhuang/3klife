...
7: if same file and same atom map but different atom ids, continue
       region-level checks
...
| `20260627-extended` | `N=50` contention | `0.003 / 0.025 / 0.031 ms` | `33.072 / 304.193 / 349.348 ms` | `0.010 / 305.309 / 865.522 ms` (`0.305 / 0.866 s` at P95 / P99) | Higher-contention stress remains concentrated in steward-mediated paths; no route-structure change is observed |

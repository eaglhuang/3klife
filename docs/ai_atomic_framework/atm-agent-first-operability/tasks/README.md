...
| [TASK-AAO-0060](./TASK-AAO-0060-branch-and-worktree-archive-inventory-after-m16-operability-chain.task.md) | Branch and worktree archive inventory after M16 operability chain | planned | `TASK-AAO-0059` | none | `git diff --check` |

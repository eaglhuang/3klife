...
| [TASK-AAO-0193](./TASK-AAO-0193-planning-root-authorship-reminder.task.md) | Remind framework imports to author 3KLife planning cards first | ready | none | `packages/cli/src/commands/tasks/planning-root-authorship.ts`<br>`packages/cli/src/commands/tasks/import-orchestrator.ts`<br>`packages/cli/src/commands/tasks/__tests__/planning-root-authorship.spec.ts`<br>`docs/governance/atm-bug-and-optimization-backlog.md` | `node --strip-types packages/cli/src/commands/tasks/__tests__/planning-root-authorship.spec.ts`<br>`node --strip-types packages/cli/src/commands/tasks/__tests__/import-orchestrator.spec.ts`<br>`npm run check:encoding:touched`<br>`git diff --check` |

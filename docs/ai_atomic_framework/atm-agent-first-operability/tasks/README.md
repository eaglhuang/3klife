...
| [TASK-AAO-0067](./TASK-AAO-0067-cli-usage-diagnostics-envelope.task.md) | CLI usage diagnostics | planned | `TASK-AAO-0002`, `TASK-AAO-0035` | `packages/cli/src/commands/shared.ts`<br>`scripts/validate-cli.ts`<br>`atomic_workbench/atomization-coverage/path-to-atom-map.json` | `npm run typecheck`<br>`npm run validate:cli`<br>`git diff --check` |

...
| [TASK-AAO-0192](./TASK-AAO-0192-abandoned-reopen-without-emergency-force.task.md) | Allow abandoned task reopen without emergency --force | done | none | `packages/cli/src/commands/tasks/legacy-impl.ts`<br>`packages/cli/src/commands/tasks/__tests__/import-orchestrator.spec.ts`<br>`docs/governance/atm-bug-and-optimization-backlog.md` | `node --strip-types packages/cli/src/commands/tasks/__tests__/import-orchestrator.spec.ts`<br>`npm run check:encoding:touched`<br>`git diff --check` |
| [TASK-AAO-0193](./TASK-AAO-0193-planning-root-authorship-reminder.task.md) | Remind framework imports to author 3KLife planning cards first | done | none | `packages/cli/src/commands/tasks/planning-root-authorship.ts`<br>`packages/cli/src/commands/tasks/import-orchestrator.ts`<br>`packages/cli/src/commands/tasks/__tests__/planning-root-authorship.spec.ts`<br>`docs/governance/atm-bug-and-optimization-backlog.md` | `node --strip-types packages/cli/src/commands/tasks/__tests__/planning-root-authorship.spec.ts`<br>`node --strip-types packages/cli/src/commands/tasks/__tests__/import-orchestrator.spec.ts`<br>`npm run check:encoding:touched`<br>`git diff --check` |
| [TASK-AAO-0194](./TASK-AAO-0194-close-deferred-governance-dirty-snapshot-enoent.task.md) | Make taskflow close tolerate deferred foreign governance-dirty snapshots | ready | none | `packages/cli/src/commands/taskflow/commit-bundle-assembly.ts`<br>`packages/cli/src/commands/taskflow.ts`<br>`packages/cli/src/commands/taskflow/__tests__/commit-bundle-assembly.spec.ts`<br>`docs/governance/atm-bug-and-optimization-backlog.md` | `node --strip-types packages/cli/src/commands/taskflow/__tests__/commit-bundle-assembly.spec.ts`<br>`npm run check:encoding:touched`<br>`git diff --check` |

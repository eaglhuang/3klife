...
# ATM 框架穩定化里程碑
> 這份頁面以 `docs/tasks/tasks-atm.json` 與 `docs/tasks/tasks-atm/tasks-atm-part-*.json` 的薄索引為準，不再沿用舊的 milestone 草稿數字。當前基線是 `done=130 / in_progress=5 / open=13 / total=148`.
## 1. 當前狀態

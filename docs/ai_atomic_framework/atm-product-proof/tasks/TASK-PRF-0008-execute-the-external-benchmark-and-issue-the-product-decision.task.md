...
acceptanceEvidence: '{"hidden-corpus-acceptance":{"id":"hidden-corpus-acceptance","claim":"The hidden benchmark corpus was accepted and sealed by its external custodian before either arm received its labels or conflict graph.","authoritativeSources":["atm.hiddenCorpusAcceptance.v1","atm.externalBenchmarkProtocol.v1"],"derivationRule":"verify-hidden-corpus-acceptance-signature-and-protocol-digest","requiredRealness":"production-ledger","verifier":{"mode":"separate-actor","actorId":"independent-adjudicator"},"negativeControls":[{"id":"unsealed-or-visible-corpus","expectedFailureReason":"hidden-corpus-not-accepted-or-visibility-policy-violated"}],"missingDataVerdict":"inconclusive","closureCritical":true},"independent-adjudication":{"id":"independent-adjudication","claim":"An independent adjudicator labeled the anonymized external runs without sharing the oracle labels with either implementer.","authoritativeSources":["atm.adjudicationManifest.v1","atm.externalBenchmarkRun.v1"],"derivationRule":"verify-independent-adjudication-signature-anonymized-input-digest-and-output-digest","requiredRealness":"production-ledger","verifier":{"mode":"separate-actor","actorId":"independent-adjudicator"},"negativeControls":[{"id":"implementer-self-adjudication","expectedFailureReason":"adjudicator-not-independent"}],"missingDataVerdict":"inconclusive","closureCritical":true},"provider-telemetry":{"id":"provider-telemetry","claim":"Each product-decision run has original provider telemetry that permits its billed-cost claim to be reproduced.","authoritativeSources":["atm.providerCostTelemetry.v1","atm.externalBenchmarkRun.v1"],"derivationRule":"verify-provider-usage-records-bind-to-run-ids-and-raw-export-digests","requiredRealness":"production-ledger","verifier":{"mode":"separate-actor","actorId":"independent-adjudicator"},"negativeControls":[{"id":"modeled-or-missing-provider-cost","expectedFailureReason":"provider-telemetry-unavailable-or-not-original"}],"missingDataVerdict":"inconclusive","closureCritical":true}}'

---
doc_id: doc_other_1012
task_id: TASK-ASA-0010
title: 補齊 validators 與 evidence pipeline 原子化
milestone: M10
status: planned
owner: atm-quality
priority: P0
depends_on: [TASK-ASA-0004, TASK-ASA-0008, TASK-ASA-0009]
...
# TASK-ASA-0010 補齊 validators 與 evidence pipeline 原子化

## 背景

把 scripts/validate-*.ts 視為 evidence 生產線，補齊 atom ownership 與 freshness rules。
...
- validator atom ownership coverage
- evidence freshness matrix
- validator-to-atom relationship report

## 驗收條件

- 每個 release gate validator 都能回連到 atom/map
- 修改 atom-owned source 時能提示應跑的 evidence command
- 缺 evidence 的 atom 不能 release promote
...
移除 validator ownership artifacts 與 freshness report。

---
doc_id: doc_other_1015
task_id: TASK-ASA-0013
title: 執行 readable entrypoint dogfood migration
milestone: M13
status: planned
owner: atm-core
priority: P1
depends_on: [TASK-ASA-0007, TASK-ASA-0008, TASK-ASA-0009, TASK-ASA-0012]
...
只在穩定邊界使用 runAtm/runAtmMap readable ref，避免把內部 helper 包成難讀黑箱。
...
- CLI command runner boundary migration
- guard/validate/test boundary migration
- registry generator and release build boundary migration

## 驗收條件

- runAtm 第一參數全部是 semantic ref
- 沒有 atmCore0005Atom 這種 ID-shaped name
- 維護者讀原本 callsite 時能理解業務意圖
...
使用 atom-ref migration report 還原 rewritten callsites。

---
doc_id: doc_other_0613
task_id: TASK-ATD-0013
title: CLI error policy：`CliError` + typed code + usage exit code
milestone: M2
status: done
...
lastTransitionId: 2026-05-21T10-29-44-212Z-migrate-legacy-ledger-acca39a09c4b
lastTransitionAt: 2026-05-21T10:29:44.212Z
ledgerContractVersion: task-ledger/v1
ledgerBaselineKind: legacy-transition-backfill
ledgerBaselineByActor: codex-main
ledgerBaselineAt: 2026-05-21T10:29:44.212Z
ledgerBaselineReason: Backfilled task-ledger/v1 baseline transition for legacy task state that predates CLI-controlled task transitions.
ledgerBaselineSourceSha256: sha256:4efe0e4c00031074723ffca65617752b8267de989988c4df602962751d65a082
---

# TASK-ATD-0013 — CLI error policy：`CliError` + typed code + usage exit code

## 目標

統一 CliError、typed code 與 usage exit code。
...
2026-05-18 | 狀態: open | 驗證: pending | 變更: 依 ATM 技術債重構計畫書開卡 | 阻塞: TASK-ATD-0007
2026-05-19 | 狀態: done | 完成: shared.ts CliError class 加入完整 JSDoc 寫明 exit code 1/2 policy；docs/cli-error-policy.md 新增公開文件

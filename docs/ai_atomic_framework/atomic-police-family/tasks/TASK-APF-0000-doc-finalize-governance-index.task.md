---
doc_id: doc_other_0242
task_id: TASK-APF-0000
title: 文件定稿與治理索引
milestone: M0
status: done
...
lastTransitionId: 2026-05-21T10-29-44-234Z-migrate-legacy-ledger-f516cd7005fb
lastTransitionAt: 2026-05-21T10:29:44.234Z
ledgerContractVersion: task-ledger/v1
ledgerBaselineKind: legacy-transition-backfill
ledgerBaselineByActor: codex-main
ledgerBaselineAt: 2026-05-21T10:29:44.234Z
ledgerBaselineReason: Backfilled task-ledger/v1 baseline transition for legacy task state that predates CLI-controlled task transitions.
ledgerBaselineSourceSha256: sha256:326aa56829fca6cccd7b890f9c281135cecab02d13638e1aebec0032dbbd49cc
---

# TASK-APF-0000 — 文件定稿與治理索引
...
建立 atomic-police-family 文件區、主計畫書、任務卡索引、doc-id 與 encoding guard。
...
- [x] 主文件與所有 task card 皆有 doc_id
- [x] tasks/README.md 連到所有 TASK-APF 卡
- [x] 主計畫書明確標示 implemented / embedded / fixture-only / missing runtime scanner
...
~~~bash
node tools_node/doc-id-registry.js --verify; npm run check:encoding:touched -- --files <APF files>
~~~

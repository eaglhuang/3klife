---
doc_id: doc_other_0249
task_id: TASK-APF-0007
title: Atomization Police 產品化規格 / design spec
milestone: M4
status: done
artifact_status: spec-done
runtime_status: not-started
upstream_mutation_status: not-applied
runtime_successor_task: TASK-APF-0025
...
整合 legacy route plan、neutrality scanner、atomize / infect dry-run proposal guard，形成 named Atomization Police 規格。
...
- atomization finding design
-  neutrality gate mapping
-  dry-run proposal constraints
-  fixture plan

## 驗收條件

- [x] atomize / infect 不可直接 apply host patch
- [x] legacy URI / no-touch zone / target surface 必須進 finding
- [x] neutrality scanner 是前置 gate
- [x] dry-run proposal 必須引用 evidence refs
- [x] 缺 redaction 或 private coupling 時 block
- [x] 引用既有 `plugin-rule-guard/src/neutrality-scanner.ts`
- [x] atomize / infect 對應 `decomposition-decision.ts:atomize / infect` decision
...
~~~bash
npm --prefix C:/Users/User/AI-Atomic-Framework run validate:neutrality-scanner; npm --prefix C:/Users/User/AI-Atomic-Framework run validate:behavior-pack
~~~
...
2026-05-18 | 狀態: done | 驗證: pass | 變更: specs/APF-0007-atomization-police-design.md 完成；引用 neutrality-scanner 與 decomposition-decision (atomize/infect) | 阻塞: none
...
2026-05-19 | 狀態: done | 驗證: M14 metadata repair | 變更: 本卡是產品化規格 / design spec，不代表 runtime scanner 已由本卡落地；runtime scanner 由 TASK-APF-0025 接手。

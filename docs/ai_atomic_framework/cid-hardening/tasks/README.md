...
| [TASK-CID-0019](./TASK-CID-0019-deterministic-composer-and-merge-plan.task.md) | P0 | Deterministic composer and MergePlan | **done** | Generates deterministic merge plans for same-file CID-disjoint proposals and rejects overlapping anchors. |

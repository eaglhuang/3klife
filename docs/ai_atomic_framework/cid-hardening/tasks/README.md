...
## P0 Next Formal Card（`TASK-CID-0005` 已正式開卡）

> 隊長指令：`TASK-CID-0005` 已升格為 P0 正式卡；下列 future queue 僅作 roadmap 對照，**不得**再把 0005 當成 future queue placeholder。
...
E0 收口後，先開 P0 正式卡 `TASK-CID-0005`（CID-first parallel conflict advisor CLI contract）；`0004 / 0006 / 0007` 接續排程。

---
task_id: TASK-ERR-0001
migrated_from_task_id: ATM-GOV-0191
...
series_selection_reason: ErrorCode lifecycle, authoring contracts, adapter parity, and registry hygiene belong to the dedicated ERR governance family; this card was migrated out of GOV so GOV numbering remains reserved for governance-optimization plan work.
scopePaths:
...
# TASK-ERR-0001 - ErrorCode Skill Authoring Contract 與 Adapter Parity
...
- Migrated from the misclassified GOV card on 2026-07-19. The prior GOV source and target ledger key are retired so GOV numbering can reuse 0191.

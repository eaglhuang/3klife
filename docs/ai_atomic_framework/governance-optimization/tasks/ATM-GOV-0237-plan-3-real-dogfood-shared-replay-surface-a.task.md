...
skl_validator_transition:
  ...
  causalImpactEdges:
    - canonical-ticket-events-to-dashboard-observations
    - bounded-proposal-to-shared-steward-output
  requiredTestCaseIds:
    - test_task_atm_gov_0237_dashboard_ticket_observations_89d5fca1
  phaseTestCaseIds:
...
- [ ] The Codex lane makes substantive code and test changes in its own actor and OS process while sharing the sealed canonical worktree/base/HEAD with 0238; it does not create or switch a Git branch, worktree, or task-local index.

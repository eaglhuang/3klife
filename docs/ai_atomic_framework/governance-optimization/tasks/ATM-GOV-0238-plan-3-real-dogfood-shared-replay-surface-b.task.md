...
Provide the second real, registered, not-yet-delivered task candidate for the
Plan 3 runtime dogfood replay. This card intentionally shares
`docs/governance/atm-3-replay-evidence.md` with ATM-GOV-0237 while keeping its
...
- [ ] No implementation control flow special-cases ATM-GOV-0238.

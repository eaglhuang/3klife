...
2. Follow `docs/ai_atomic_framework/release_version_flow/RELEASE_CHECKLIST.md` section 7 for alpha0/alpha1 split gates.
...
2. Release execution record section in `docs/ai_atomic_framework/release_version_flow/RELEASE_CHECKLIST.md`.

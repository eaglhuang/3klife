...
validators:
  ...
  - node atm.mjs team start --task TASK-AAO-0041 --actor codex-main --json
...
# TASK-TEAM-0002: team start/status runtime

## Goal

Add team start/status runtime commands that write and read .atm/runtime/team-runs/<teamRunId>.json.

...
deliverables:
  - "Closure packets can include optional Team Agents attestation metadata."
  - "Team summary records runnerKind, runtimeVersion, sandboxPolicyHash, and attestationSigner when available."
  - "Team attestation remains supporting metadata and never replaces command-backed validators."
  - "Existing stdoutSha256/stderrSha256 commandRuns remain compatible unless a separate migration card changes them."
  - "scripts/validate-team-agents.ts contains a sandbox-attestation case."

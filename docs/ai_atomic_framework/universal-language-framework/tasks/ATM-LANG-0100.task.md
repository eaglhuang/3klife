---
doc_id: doc_other_0906
task_id: ATM-LANG-0100
title: LanguageAdapter v2 public contract
...
- [x] 保留 v1 detectProjectProfile / validateComputeAtom
- [x] 新增 additive v2 optional surface
- [x] capabilities 與 contractVersion 可驗證
...
- 不得破壞既有 language-js / language-python assignability。
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start contract implementation | 阻塞: none
2026-05-20 | 狀態: done | 驗證: node scripts/validate-plugin-sdk.ts（PASS） | 變更: 新增 `packages/plugin-sdk/src/language-adapter.ts` 並補 `docs/ADAPTER_GUIDE.md` v2 contract snapshot | 阻塞: none

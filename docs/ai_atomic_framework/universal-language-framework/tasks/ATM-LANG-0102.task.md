---
doc_id: doc_other_0908
task_id: ATM-LANG-0102
title: Runtime/equivalence/evidence contracts
...
- 相關表格：ATM-LANG-TABLE-0006, ATM-LANG-TABLE-0007

## Outputs

- [x] runtime command report contract
- [x] equivalence fixture contract
- [x] dry-run evidence envelope contract
...
```bash
node scripts/validate-plugin-sdk.ts
node scripts/validate-schemas.ts
```

## Implementation Notes

- Evidence envelope 必須可被 police / validator 消費。
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start runtime/evidence contract implementation | 阻塞: none
2026-05-20 | 狀態: done | 驗證: node scripts/validate-plugin-sdk.ts、node scripts/validate-schemas.ts（PASS） | 變更: 完成 runtime command/equivalence fixture/evidence envelope 契約與 validator 對齊 | 阻塞: none

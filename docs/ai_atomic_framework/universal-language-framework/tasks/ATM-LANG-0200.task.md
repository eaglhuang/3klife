---
doc_id: doc_other_0909
task_id: ATM-LANG-0200
title: Adapter registry and resolver
...
- [x] adapter registry module
- [x] resolver selection report
- [x] resolver fixtures
...
- resolver 只看 adapter metadata，不在 core 寫語言分支。
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start adapter registry/resolver implementation | 阻塞: none
2026-05-20 | 狀態: done | 驗證: TS_NODE_PROJECT=tsconfig.test.json + resolver tests（PASS）, script-facade-boundary（PASS） | 變更: 新增 registry/discovery/resolver 與 resolver fixtures | 阻塞: none

---
doc_id: doc_other_0914
task_id: ATM-LANG-0302
title: Guidance and police integration update
...
- 相關表格：ATM-LANG-TABLE-0006, ATM-LANG-TABLE-0009

## Outputs

- [x] guidance consumes adapter reports
- [x] police family can cite adapter evidence
- [x] fixtures cover delegated and fallback paths
...
```bash
node scripts/validate-police-family.ts
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start guidance/police integration update | 阻塞: none
2026-05-20 | 狀態: done | 驗證: node scripts/validate-police-family.ts（PASS）, TS_NODE_PROJECT=tsconfig.test.json integration tests（PASS） | 變更: 新增 police adapter evidence consumer 與 delegated/fallback fixtures | 阻塞: none

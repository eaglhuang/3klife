---
doc_id: doc_other_0924
task_id: ATM-LANG-0700
title: Python AST inventory and symbol ranges
...
- 此卡升級既有 language-python，不建立第二套 Python adapter。
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start Python AST inventory implementation | 阻塞: none
2026-05-20 | 狀態: done | 驗證: npm run validate:python-adapter（PASS） | 變更: Python AST inventory、symbol range 與 sample fixtures 已完成 | 阻塞: none

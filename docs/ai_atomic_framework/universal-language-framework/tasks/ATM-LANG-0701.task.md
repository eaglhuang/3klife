---
doc_id: doc_other_0925
task_id: ATM-LANG-0701
title: Python dependency/call/artifact graph
...
- [x] Python dependency graph
- [x] Python call graph advisory report
- [x] artifact graph where deterministic
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start Python dependency/call/artifact graph implementation | 阻塞: none
2026-05-20 | 狀態: done | 驗證: npm run validate:python-adapter（PASS） | 變更: dependency/call/artifact graph 產出完成，呼叫圖以 advisory 準則呈現 | 阻塞: none

---
doc_id: doc_other_0928
task_id: ATM-LANG-0704
title: Python equivalence fixtures and diagnostics
atomic_map: ATM-MAP-LANG-0700
milestone: M5
status: done
started_at: 2026-05-20T16:05:29+08:00
started_by_agent: codex-gpt-5
completed_at: 2026-05-20T16:09:14+08:00
owner: atm-core
priority: P1
type: validation
...
- [x] Python diagnostics parser
- [x] equivalence fixtures
- [x] validator expansion
...
- diagnostics parser 必須 fixture-backed，不靠執行真實 Python。
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start Python equivalence fixtures and diagnostics implementation | 阻塞: none
2026-05-20 | 狀態: done | 驗證: npm run validate:python-adapter（PASS） | 變更: diagnostics parser 與 equivalence fixture 驗證完成 | 阻塞: none

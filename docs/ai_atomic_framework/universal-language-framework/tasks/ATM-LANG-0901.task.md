---
doc_id: doc_other_0933
task_id: ATM-LANG-0901
title: English guide: complete Go adapter code example
...
- [x] complete TypeScript Go adapter example
- [x] capabilities example
- [x] runtime/diagnostics/dry-run examples
...
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: lock card and start complete Go adapter example | 阻塞: none
2026-05-20 | 狀態: done | 驗證: npm run validate:guide（PASS） | 變更: complete Go adapter example、capabilities、runtime/diagnostics/dry-run 範例完成 | 阻塞: none

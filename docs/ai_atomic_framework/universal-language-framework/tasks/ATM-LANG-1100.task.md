---
doc_id: doc_other_0939
task_id: ATM-LANG-1100
title: Cross-map validator suite
...
- 相關表格：ATM-LANG-TABLE-0006, ATM-LANG-TABLE-0007, ATM-LANG-TABLE-0009

## Outputs

- [x] cross-map validator suite
- [x] type/schema/guidance/adapter coverage checks
- [x] validator ownership matrix
...
- 此卡把分散 validator 串成 regression suite。
...
2026-05-20 | 狀態: done | 驗證: npm run validate:full（PASS）, npm run validate:guide（PASS）, npm run check:encoding:touched（PASS） | 變更: cross-map suite 串接 SDK/schema/guidance/Python/JS/map/traceability/facade/neutrality validators | 阻塞: none
2026-05-20 | 狀態: in-progress | 驗證: pending | 變更: codex-gpt-5 接手 cross-map validator suite | 阻塞: none

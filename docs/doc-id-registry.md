...
| Tech / UI / Art / Data | docs/doc-id-registry-md-shards/doc-id-registry-tech-ui-art.md | 102 | 單一分片 |
| Spec / Index / Task | docs/doc-id-registry-md-shards/doc-id-registry-spec-index-task.md | 12 | 3 個 parts |
| AI / AgentSkill / Server | docs/doc-id-registry-md-shards/doc-id-registry-agent-server.md | 203 | 單一分片 |
| 其它類 | docs/doc-id-registry-md-shards/doc-id-registry-other.md | 228 | 單一分片 |

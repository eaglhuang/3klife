...
> **Legacy / archived**：本檔是舊 Agent1/Agent2 多 Agent 協作時代的人工 To-Do 追蹤文件。現行流程改以任務卡、docs/tasks/ shard、docs/ui-quality-tasks/ shard、docs/agent-briefs/tasks_index.md 與 
ode tools_node/build-ui-task-manifest.js 為準。
...
1. **Agent 啟動 3 必讀**：`docs/keep.md (doc_index_0011)` (doc_index_0011) → `docs/legacy/agent-collaboration/ui-quality-todo.md (doc_ui_0035)` (doc_ui_0035)（本檔）→ `docs/UI參考圖品質分析.md (doc_ui_0051)` (doc_ui_0051)

...
depends:
  - TASK-DGB-0001
notes: "2026-05-18 | 狀態: done | 驗證: node-syntax-check=pass, backup-validator list=ok | 變更: upgrade-planner.js / backup-validator.js / rollback-test-fixtures.json 建立完成 | 阻塞: 無"
---

...
- Round ID: `abab-live-r4-route-a1-merged`
- Generated At: `2026-05-02T04:55:30+00:00`
- Overall Estimate: `58.39%`
...
| `eventQuestionCoverage` | 32.0 | 0.4657 | 14.90 |
| `taxonomyAngles` | 13.0 | 0.7596 | 9.87 |
| `reviewValidation` | 6.0 | 0.3596 | 2.16 |
...
- `previewAcceptedA`: `1308`
- `previewReviewB`: `2114`
- `previewTotalAnswers`: `3422`
...
- `abab-live-r4-route-a1`: `{'A': 15, 'B': 10}` from `scratch/abab-live-r4-route/abab-live-r4-route/repair-review/backlog-repair-tasks/abab-live-r4-route-a1-repair-review-candidates.jsonl`
